            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="font-semibold text-gray-900">Previous: Financial Basics</span>
                </div>
                <p className="text-gray-600">Learn the fundamentals of money, investing, and building wealth in simple terms.</p>
              </Link>
