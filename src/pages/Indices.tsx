      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            {indices.map((index, i) => <Card key={index.name} className={`border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-glow group ${expandedIndex === index.name ? 'lg:col-span-3' : ''}`}>
                  ...
                  {expandedIndex === index.name && <div className="mt-6 animate-fade-in">
                      <div className="border-t pt-6">
                        ...
                        <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-3">
                          {index.characteristics.map((char, charIndex) => <div key={charIndex} className="text-center p-3 bg-muted/30 rounded-lg">
