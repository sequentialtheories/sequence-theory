              ...
              >
                <CardHeader className="text-center pb-4">
                  <div className="flex justify-center mb-4">
                    <div className="p-4 rounded-full bg-gradient-primary/10 group-hover:bg-gradient-primary/20 transition-colors">
                      {React.cloneElement(index.icon, { className: "h-8 w-8 text-primary" })}
                    </div>
                  </div>
                ...
                <CardContent>
                  ...
                  <div className="space-y-3">
                    {index.features.map((feature, featureIndex) => (
                      <div 
                        key={featureIndex}
            ...
            <Card className="border-primary/20 bg-gradient-secondary/50 backdrop-blur-sm">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Join The Vault Club to access these professionally managed indices and start building 
                  your digital asset portfolio today.
                </p>
                <Button 
                  size="lg"
                  className="bg-gradient-primary hover:shadow-glow text-primary-foreground px-8 py-3 rounded-full transition-spring hover:scale-105"
