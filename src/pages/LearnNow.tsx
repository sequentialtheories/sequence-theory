            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-10 border border-white/20 shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {learningCategories.map((category, index) => <button key={index} onClick={() => setSelectedCategory(index)} className={`group relative p-8 text-center rounded-2xl transition-all duration-500 transform hover:-translate-y-2 ${selectedCategory === index ? 'bg-gradient-to-br from-cyan-500 to-blue-500 text-white shadow-2xl scale-105' : 'bg-white border-2 border-cyan-300 hover:bg-gradient-to-br hover:from-cyan-100 hover:to-blue-100 hover:border-cyan-400 shadow-lg hover:shadow-xl'}`}>
                      <div className={`absolute inset-0 rounded-2xl blur-xl opacity-20 ${selectedCategory === index ? 'bg-gradient-to-br from-cyan-500 to-blue-500' : 'bg-cyan-300'}`}></div>
