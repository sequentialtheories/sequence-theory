            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="block bg-white border border-gray-200 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-3">
                  <span className="font-semibold text-gray-900">Previous: None</span>
                </div>
                <p className="text-gray-600">This is the first step in your digital asset education journey.</p>
              </div>
